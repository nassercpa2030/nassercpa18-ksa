...
class CloseEntryWizard ( models.TransientModel ) :
    ...
    invoice_lines = fields.One2many ( 'invoice.line.wizard' , 'wizard_id' , string='Invoice Lines' , readonly=False ,
                                      store=True )
        ...
        for wizard in self :
            ...
            for line in wizard.invoice_lines :
                ...
                if line.x_studio_analytic_account_test :
                    analytic_account = AnalyticAccount.search ( [('name' , '=' , line.x_studio_analytic_account_test)] ,
                                                                limit=1 )
                    if analytic_account :
