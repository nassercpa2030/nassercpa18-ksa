...
class AuthorizeAircallApi():
    ...
    def get_numbers(self):
        ...
        user_pass = base64.b64encode(bytes("%s:%s" % (
            self.api_id, self.api_token), encoding='utf8')).decode('ascii')
