...
class AccountMoveLine ( models.Model ) :
    ...
    def _get_office_supp_perc(self) :
        for rec in self :
            ...
            distribution_vals_analytic = {
                analytic_account_id.id : 100.0,
            ...
            # الحالة الثانية
             ...
             # الحالة الثانية
            elif rec.analytic_account_id and rec.account_id.code.startswith (
                    '410' ) :
                 rec.analytic_distribution = distribution_vals_analytic
...
class AnalyticDistributuion ( models.Model ) :
    ...
    finance_101_distribution_amount = fields.Monetary ( string="101 نسبة توزيع المالية علي " , currency_field='currency_id' ,compute="_compute_dist_percentage" , readonly=False , store=True)
    finance_104_distribution_amount = fields.Monetary ( string="104 نسبة توزيع المالية علي " , currency_field='currency_id' ,compute="_compute_dist_percentage" , readonly=False, store=True)
