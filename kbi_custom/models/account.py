...
class AccountPayment(models.Model):
    ...
    destination_account_id= fields.Many2one('account.account',string='Destination Account',readonly=False ,domain=[("user_type_id.type", 'in',['asset_receivable','asset_cash'])],store=True)
