...
class AnalyticDistributuion ( models.Model ) :
    ...
    finance_101_distribution_amount = fields.Monetary ( string="101 نسبة توزيع المالية علي " , currency_field='currency_id' ,compute="_compute_dist_percentage" , readonly=False ,groups="base.group_system,account.distribution_amount_101", store=True)
    finance_104_distribution_amount = fields.Monetary ( string="104 نسبة توزيع المالية علي " , currency_field='currency_id' ,compute="_compute_dist_percentage" , readonly=False,groups="base.group_system,account.distribution_amount_104" , store=True)
    ...
    finance_200_distribution_amount = fields.Monetary ( string="200 نسبة توزيع المالية علي " , currency_field='currency_id' ,compute="_compute_dist_percentage" , readonly=False ,groups="base.group_system,account.distribution_amount_200", store=True)
