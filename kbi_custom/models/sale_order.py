...
class SaleOrder ( models.Model ) :
    ...
    unpaid_total_refrence = fields.Boolean('unpaid_total_refrence',store=True,readonly=False)
    paid_total_refrence = fields.Boolean('paid_total_refrence',store=True,readonly=False)
    paid_percentage_refrence= fields.Boolean('paid_percentage_refrence',store=True,readonly=False)
    ...
    project_budget_refrence= fields.Boolean('project_budget_refrence',store=True,readonly=False)
    ...
    order_line_total_refrence=fields.Boolean('order_line_total_refrence',store=True,readonly=False)
    order_line_subtotal_refrence=fields.Boolean('order_line_subtotal_refrence',store=True,readonly=False)
