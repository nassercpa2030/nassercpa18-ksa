...
class SaleOrder ( models.Model ) :
    ...
    cr_number_sale =fields.Char(related='partner_id.l10n_sa_additional_identification_number',string="Customer CR Number",required=False,readonly=False,store=True)
