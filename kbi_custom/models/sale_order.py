...
class SaleOrder ( models.Model ) :
    ...
    customer_phone_number = fields.String(string='تيلفون العميل',related='partner_id.mobile' ,required=True,store=True )
...
class SaleOrder ( models.Model ) :
    ...
    account_year = fields.Integer ( string='Year' , required=True , compute='compute_audit_year',index=True,readonly=False )
    agreement_id = fields.Many2one ( 'kbi.sale.agreement' , string='Agreement' )
    payment_ids = fields.Many2many ( 'account.payment' , string='Payments' , compute='_compute_payment_ids' )
    payment_count = fields.Integer ( string="Payment Count" , compute="_compute_payment_count" )
