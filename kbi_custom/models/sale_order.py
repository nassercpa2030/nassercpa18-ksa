...
class SaleOrder ( models.Model ) :
   ...
   # broker_uninvoiced_amount = fields.Float ( string='Broker Unpaid Amount' ,
    ...
    uuid = fields.Char ( string='UUID' )
    final_close_entry_date = fields.Date ( string="تاريخ قيد الايراد" , compute='_compute_final_close_entry_date',readonly=False,index=True,searchable=True,store=True)
    close_entry_date = fields.Date (string="Close Entry Date" ,store=True, readonly=False ,index=True,searchable=True)
