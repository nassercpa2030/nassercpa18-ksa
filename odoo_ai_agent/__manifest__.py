...

{
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'odoo_ai_agent/static/src/js/view_ai_modal.js',
            'odoo_ai_agent/static/src/xml/view_ai_modal.xml',
            'odoo_ai_agent/static/src/xml/agent_details.xml',
            'odoo_ai_agent/static/src/css/modal_custom.css',
            'odoo_ai_agent/static/src/js/agent_details.js',
